...
mod painter {
    ...
    use wgpu::{
        ...
        Extent3d, FilterMode, FragmentState, FrontFace, ImageCopyTexture, ImageDataLayout,
        IndexFormat, MultisampleState, Origin3d, PipelineLayoutDescriptor, PolygonMode,
    ...
    impl EguiPainter {
        ...
        pub fn upload_egui_data(
            ...
            // first deal with textures
            {
                ...
                let delete_textures =
                    std::mem::replace(&mut self.delete_textures, textures_delta.free);
